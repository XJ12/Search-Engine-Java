...
public class title {
	...
	public static void main(String args[]) throws IOException
	{
		...
		{
			try {
				in=new FileReader("data_t/"+i+".txt");
		...
		FileOutputStream out=new FileOutputStream("index_word_title.txt");
		...
		{
			FileOutputStream out1=new FileOutputStream("index_w_title"+x+".txt");
		...
		FileOutputStream out1=new FileOutputStream("index_title.txt");
		PrintStream p1=new PrintStream(out1); 
		for(int x=0;x<=TOTAL/patch;x++)
		{
			in_array[x]=new FileReader("index_w_title"+x+".txt");
		...
		out=new FileOutputStream("index_two_word_title.txt");
		...
		for(int x=0;x<=TOTAL/patch;x++)
		{
			out1=new FileOutputStream("two_index_w_title"+x+".txt");
		...
		out1=new FileOutputStream("index_two_title.txt");
		p1=new PrintStream(out1); 
		for(int x=0;x<=TOTAL/patch;x++)
		{
			in_array[x]=new FileReader("two_index_w_title"+x+".txt");
			p_array[x]=new BufferedReader(in_array[x]); 
		}
		for(int i=0;i<info.size();i++)
		{
